...
:choco
	...
	choco install dotnet-desktopruntime sqlitebrowser opera notepadplusplus google-chrome-x64 firefox adobereader googleearth windirstat git github-desktop python eclipse postman openoffice sql-server-express sql-server-management-studio -y
goto :eof
