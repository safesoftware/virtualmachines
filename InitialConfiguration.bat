...
:choco
	...
	choco install notepadplusplus google-chrome-x64 firefox adobereader ultravnc googleearth windirstat git python eclipse postman openoffice choco install sqlserverexpress -y
goto :eof
